...
@WebServlet("/UpdateDeleteComplaintServlet")
public class UpdateDeleteComplaintServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user != null) {
			...
			RequestDispatcher requestDispatcher = request.getRequestDispatcher("updateDeleteComplaint.jsp");
