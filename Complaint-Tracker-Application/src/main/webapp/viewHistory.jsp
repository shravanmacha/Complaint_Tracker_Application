...
<h1 style="text-align: center; color: #020b69;">Your Complaints</h1>
<table border="1">
<tr>
<th>ComplaintId</th>
...
<% List<Complaint> complaintList = (List<Complaint>)request.getAttribute("solvedComplaints");
...
<a  style="text-decoration: none" href="complaints.jsp">Go to Home Page</a>
